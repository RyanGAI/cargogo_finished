...
echo_and_run /usr/bin/env \
    PYTHONPATH="/home/kal5-1/cargogo/install/lib/python2.7/dist-packages:/home/kal5-1/cargogo/build/cv_bridge/lib/python2.7/dist-packages:$PYTHONPATH" \
    CATKIN_BINARY_DIR="/home/kal5-1/cargogo/build/cv_bridge" \
    "/opt/mrtsoftware/release/lib/mrt-build-tools/bin/python" \
    "/home/kal5-1/cargogo/src/vision_opencv/cv_bridge/setup.py" \
    build --build-base "/home/kal5-1/cargogo/build/cv_bridge" \
    install \
    $DESTDIR_ARG \
