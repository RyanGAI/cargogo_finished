...
if("FALSE" STREQUAL "TRUE")
  ...
  set(mrt_cv_bridge_ros_DEVEL_PREFIX /home/kal5-1/cargogo/devel/.private/mrt_cv_bridge_ros)
  ...
  set(mrt_cv_bridge_ros_INSTALL_PREFIX /home/kal5-1/cargogo/install)
...
if(NOT "include;/usr/include;/opt/mrtsoftware/release/include/opencv-3.3.1;/opt/mrtsoftware/release/include/opencv-3.3.1/opencv " STREQUAL " ")
  set(mrt_cv_bridge_ros_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include;/opt/mrtsoftware/release/include/opencv-3.3.1;/opt/mrtsoftware/release/include/opencv-3.3.1/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mrt_cv_bridge_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kal5-1/cargogo/install/${idir}'.  ${_report}")
    endif()
