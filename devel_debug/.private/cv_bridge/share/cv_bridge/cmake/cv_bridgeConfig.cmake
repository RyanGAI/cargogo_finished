...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/kal5-1/cargogo/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/kal5-1/cargogo/devel_debug/.private/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/kal5-1/cargogo/install_debug)
...
if(NOT "/home/kal5-1/cargogo/src/vision_opencv/cv_bridge/include;/opt/mrtsoftware/release/include/opencv-3.3.1;/opt/mrtsoftware/release/include/opencv-3.3.1/opencv " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/kal5-1/cargogo/src/vision_opencv/cv_bridge/include;/opt/mrtsoftware/release/include/opencv-3.3.1;/opt/mrtsoftware/release/include/opencv-3.3.1/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kal5-1/cargogo/src/vision_opencv/cv_bridge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cv_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_bridge;/opt/mrtsoftware/release/lib/libopencv_core3.so.3.3.1;/opt/mrtsoftware/release/lib/libopencv_imgproc3.so.3.3.1;/opt/mrtsoftware/release/lib/libopencv_imgcodecs3.so.3.3.1")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kal5-1/cargogo/devel_debug/.private/cv_bridge/lib;/home/kal5-1/cargogo/devel_debug/lib;/home/kal5-1/cargogo/devel/lib;/opt/mrtsoftware/local/lib;/opt/mrtsoftware/release/lib;/opt/ros/kinetic/lib)
