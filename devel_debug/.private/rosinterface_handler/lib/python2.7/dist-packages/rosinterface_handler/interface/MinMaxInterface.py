...
inf = float('inf')
param_description = [{'constant': False, 'description': 'An Integer parameter', 'pytype': 'int', 'max': 2, 'is_vector': False, 'edit_method': '""', 'name': 'int_param_w_minmax', 'min': 0, 'default': 3, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'int'}, {'constant': False, 'description': 'A double parameter', 'pytype': 'double', 'max': 2.0, 'is_vector': False, 'edit_method': '""', 'name': 'double_param_w_minmax', 'min': 0.0, 'default': 3.1, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'A vector of int parameter', 'max': 2, 'is_vector': True, 'edit_method': '""', 'name': 'vector_int_param_w_minmax', 'min': 0, 'default': [-1, 2, 3], 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::vector<int>'}, {'constant': False, 'description': 'A vector of double parameter', 'max': 2.0, 'is_vector': True, 'edit_method': '""', 'name': 'vector_double_param_w_minmax', 'min': 0.0, 'default': [-1.1, 1.2, 2.3], 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::vector<double>'}, {'constant': False, 'description': 'A map parameter', 'max': 2.0, 'is_vector': False, 'edit_method': '""', 'name': 'map_param_w_minmax', 'min': 0.0, 'default': {'value3': 2.2, 'value2': 1.2, 'value1': -1.2}, 'level': 0, 'is_map': True, 'configurable': False, 'global_scope': False, 'type': 'std::map<std::string,double>'}]
