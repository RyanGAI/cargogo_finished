...
inf = float('inf')
param_description = [{'constant': False, 'description': 'Sets the verbosity for this node', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': 'verbosity', 'name': 'verbosity', 'min': None, 'default': 'info', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_debug', 'min': None, 'default': 'debug', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_info', 'min': None, 'default': 'info', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_warning', 'min': None, 'default': 'warning', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_error', 'min': None, 'default': 'error', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_fatal', 'min': None, 'default': 'fatal', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'if true do erosion, toherwise dilation', 'pytype': 'bool', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'erode', 'min': None, 'default': False, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'bool'}, {'constant': False, 'description': '0.5* kernel sioze of the filter', 'pytype': 'int', 'max': 20, 'is_vector': False, 'edit_method': '""', 'name': 'half_kernel_size', 'min': 0, 'default': 3, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}, {'constant': False, 'description': 'Topic for subscriber', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'subscriber_topic', 'min': None, 'default': 'in_topic', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Queue size for subscriber', 'pytype': 'int', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'subscriber_queue_size', 'min': 0, 'default': 5, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}, {'constant': False, 'description': 'Topic for publisher', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'publisher_topic', 'min': None, 'default': 'out_topic', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Queue size for publisher', 'pytype': 'int', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'publisher_queue_size', 'min': 0, 'default': 5, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}]
subscriber_description = [{'topic_param': 'subscriber_topic', 'description': 'subscriber', 'header': None, 'min_frequency_param': None, 'import': 'sensor_msgs.msg', 'name': 'subscriber', 'queue_size_param': 'subscriber_queue_size', 'no_delay': True, 'configurable': True, 'max_delay_param': None, 'diagnosed': False, 'scope': 'private', 'type': 'sensor_msgs::Image'}]
publisher_description = [{'topic_param': 'publisher_topic', 'description': 'publisher', 'header': None, 'min_frequency_param': None, 'scope': 'private', 'name': 'publisher', 'queue_size_param': 'publisher_queue_size', 'configurable': True, 'max_delay_param': None, 'diagnosed': False, 'import': 'sensor_msgs.msg', 'type': 'sensor_msgs::Image'}]
...
class LabelDilationInterface(dict):
    def __init__(self):
