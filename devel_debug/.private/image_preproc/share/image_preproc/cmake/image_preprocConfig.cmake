...
if(image_preproc_CONFIG_INCLUDED)
  return()
endif()
set(image_preproc_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(image_preproc_SOURCE_PREFIX /home/kal5-1/cargogo/src/image_preproc)
  set(image_preproc_DEVEL_PREFIX /home/kal5-1/cargogo/devel_debug/.private/image_preproc)
  set(image_preproc_INSTALL_PREFIX "")
  set(image_preproc_PREFIX ${image_preproc_DEVEL_PREFIX})
else()
  set(image_preproc_SOURCE_PREFIX "")
  set(image_preproc_DEVEL_PREFIX "")
  set(image_preproc_INSTALL_PREFIX /home/kal5-1/cargogo/install_debug)
  set(image_preproc_PREFIX ${image_preproc_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'image_preproc' is deprecated")
...
set(image_preproc_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/kal5-1/cargogo/src/image_preproc/include;/opt/mrtsoftware/release/include/opencv-3.3.1;/opt/mrtsoftware/release/include/opencv-3.3.1/opencv " STREQUAL " ")
  set(image_preproc_INCLUDE_DIRS "")
  set(_include_dirs "/home/kal5-1/cargogo/src/image_preproc/include;/opt/mrtsoftware/release/include/opencv-3.3.1;/opt/mrtsoftware/release/include/opencv-3.3.1/opencv")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kal5-1/cargogo/devel_debug/.private/image_preproc/lib;/home/kal5-1/cargogo/devel_debug/lib;/home/kal5-1/cargogo/devel/lib;/opt/mrtsoftware/local/lib;/opt/mrtsoftware/release/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(image_preproc_LIBRARY_DIRS ${lib_path})
      list(APPEND image_preproc_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'image_preproc'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND image_preproc_LIBRARIES ${lib})
    endif()
  endif()
...
set(image_preproc_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${image_preproc_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 image_preproc_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${image_preproc_dep}_FOUND)
      find_package(${image_preproc_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${image_preproc_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(image_preproc_INCLUDE_DIRS ${${image_preproc_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(image_preproc_LIBRARIES ${image_preproc_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${image_preproc_dep}_LIBRARIES})
  _list_append_deduplicate(image_preproc_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(image_preproc_LIBRARIES ${image_preproc_LIBRARIES})

  _list_append_unique(image_preproc_LIBRARY_DIRS ${${image_preproc_dep}_LIBRARY_DIRS})
  list(APPEND image_preproc_EXPORTED_TARGETS ${${image_preproc_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${image_preproc_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
