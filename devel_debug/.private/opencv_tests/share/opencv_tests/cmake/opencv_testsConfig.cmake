...
if("TRUE" STREQUAL "TRUE")
  set(opencv_tests_SOURCE_PREFIX /home/kal5-1/cargogo/src/vision_opencv/opencv_tests)
  set(opencv_tests_DEVEL_PREFIX /home/kal5-1/cargogo/devel_debug/.private/opencv_tests)
  ...
  set(opencv_tests_INSTALL_PREFIX /home/kal5-1/cargogo/install_debug)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'opencv_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kal5-1/cargogo/src/vision_opencv/opencv_tests/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kal5-1/cargogo/devel_debug/.private/opencv_tests/lib;/home/kal5-1/cargogo/devel_debug/lib;/home/kal5-1/cargogo/devel/lib;/opt/mrtsoftware/local/lib;/opt/mrtsoftware/release/lib;/opt/ros/kinetic/lib)
