...
if("TRUE" STREQUAL "TRUE")
  ...
  set(lateral_control_ros_tool_DEVEL_PREFIX /home/kal5-1/cargogo/devel/.private/lateral_control_ros_tool)
  ...
  set(lateral_control_ros_tool_INSTALL_PREFIX /home/kal5-1/cargogo/install)
...
if(NOT "/home/kal5-1/cargogo/devel/.private/lateral_control_ros_tool/include " STREQUAL " ")
  set(lateral_control_ros_tool_INCLUDE_DIRS "")
  set(_include_dirs "/home/kal5-1/cargogo/devel/.private/lateral_control_ros_tool/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lateral_control_ros_tool' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kal5-1/cargogo/src/lateral_control_ros_tool/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kal5-1/cargogo/devel/.private/lateral_control_ros_tool/lib;/home/kal5-1/cargogo/devel/lib;/opt/mrtsoftware/local/lib;/opt/mrtsoftware/release/lib;/opt/ros/kinetic/lib)
