...
// *********************************************************
//
// File autogenerated for the prosilica_driver package
// by the dynamic_reconfigure package.
// Please do not edit.
//
// ********************************************************/

#ifndef __prosilica_driver__PROSILICACAMERACONFIG_H__
#define __prosilica_driver__PROSILICACAMERACONFIG_H__
...
//#line 292 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(ProsilicaCameraConfig::AbstractParamDescriptionConstPtr(new ProsilicaCameraConfig::ParamDescription<std::string>("trigger_mode", "str", 1, "Camera trigger mode", "{'enum_description': 'Enum to set the trigger mode', 'enum': [{'srcline': 10, 'description': 'Run at maximum frame rate', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'streaming', 'ctype': 'std::string', 'type': 'str', 'name': 'StreamingMode'}, {'srcline': 11, 'description': 'Trigger from software', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'software', 'ctype': 'std::string', 'type': 'str', 'name': 'SoftwareMode'}, {'srcline': 12, 'description': 'Capture frame in response to service call', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'polled', 'ctype': 'std::string', 'type': 'str', 'name': 'PolledMode'}, {'srcline': 13, 'description': 'Capture frame in response to trigger topic', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'triggered', 'ctype': 'std::string', 'type': 'str', 'name': 'TriggerMode'}, {'srcline': 14, 'description': 'Fixed Rate mode', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'fixedrate', 'ctype': 'std::string', 'type': 'str', 'name': 'FixedRateMode'}, {'srcline': 15, 'description': 'External trigger on SyncIn1 line', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'syncin1', 'ctype': 'std::string', 'type': 'str', 'name': 'External1Mode'}, {'srcline': 16, 'description': 'External trigger on SyncIn2 line', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'syncin2', 'ctype': 'std::string', 'type': 'str', 'name': 'External2Mode'}]}", &ProsilicaCameraConfig::trigger_mode)));
//#line 292 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(ProsilicaCameraConfig::AbstractParamDescriptionConstPtr(new ProsilicaCameraConfig::ParamDescription<std::string>("trigger_mode", "str", 1, "Camera trigger mode", "{'enum_description': 'Enum to set the trigger mode', 'enum': [{'srcline': 10, 'description': 'Run at maximum frame rate', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'streaming', 'ctype': 'std::string', 'type': 'str', 'name': 'StreamingMode'}, {'srcline': 11, 'description': 'Trigger from software', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'software', 'ctype': 'std::string', 'type': 'str', 'name': 'SoftwareMode'}, {'srcline': 12, 'description': 'Capture frame in response to service call', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'polled', 'ctype': 'std::string', 'type': 'str', 'name': 'PolledMode'}, {'srcline': 13, 'description': 'Capture frame in response to trigger topic', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'triggered', 'ctype': 'std::string', 'type': 'str', 'name': 'TriggerMode'}, {'srcline': 14, 'description': 'Fixed Rate mode', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'fixedrate', 'ctype': 'std::string', 'type': 'str', 'name': 'FixedRateMode'}, {'srcline': 15, 'description': 'External trigger on SyncIn1 line', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'syncin1', 'ctype': 'std::string', 'type': 'str', 'name': 'External1Mode'}, {'srcline': 16, 'description': 'External trigger on SyncIn2 line', 'srcfile': '/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg', 'cconsttype': 'const char * const', 'value': 'syncin2', 'ctype': 'std::string', 'type': 'str', 'name': 'External2Mode'}]}", &ProsilicaCameraConfig::trigger_mode)));
//#line 292 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 10 "/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg"
      const char * const ProsilicaCamera_StreamingMode = "streaming";
//#line 11 "/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg"
      const char * const ProsilicaCamera_SoftwareMode = "software";
//#line 12 "/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg"
      const char * const ProsilicaCamera_PolledMode = "polled";
//#line 13 "/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg"
      const char * const ProsilicaCamera_TriggerMode = "triggered";
//#line 14 "/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg"
      const char * const ProsilicaCamera_FixedRateMode = "fixedrate";
//#line 15 "/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg"
      const char * const ProsilicaCamera_External1Mode = "syncin1";
//#line 16 "/home/kal5-1/cargogo/src/prosilica_driver/cfg/ProsilicaCamera.cfg"
