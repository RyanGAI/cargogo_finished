...
inf = float('inf')
param_description = [{'constant': False, 'description': 'Queusize for publisher', 'pytype': 'int', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'msg_queue_size', 'min': 1, 'default': 5, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'int'}, {'constant': False, 'description': 'Sets the verbosity for this node', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': 'verbosity', 'name': 'verbosity', 'min': None, 'default': 'info', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_debug', 'min': None, 'default': 'debug', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_info', 'min': None, 'default': 'info', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_warning', 'min': None, 'default': 'warning', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_error', 'min': None, 'default': 'error', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': True, 'description': 'Constant for enum verbosity', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'verbosity_fatal', 'min': None, 'default': 'fatal', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Path to the topic containing the image_topic and the disp_topic', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'base_path', 'min': None, 'default': 'in_topic', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Name of the image topic', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'image_topic', 'min': None, 'default': 'image', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Name of the disparity topic', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'disp_topic', 'min': None, 'default': 'disp', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Name of the output pointcloud', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'pointcloud_topic', 'min': None, 'default': 'pointcloud', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Name of the camera info topic', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'info_topic', 'min': None, 'default': 'camera_info', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Value in image to be seen as invalid (negative means inactive)', 'pytype': 'int', 'max': 255, 'is_vector': False, 'edit_method': '""', 'name': 'invalid_value', 'min': -1, 'default': -1, 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'int'}, {'constant': False, 'description': 'Map intensiy values (input), must be same size as output', 'max': None, 'is_vector': True, 'edit_method': '""', 'name': 'remap_in', 'min': None, 'default': None, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::vector<int>'}, {'constant': False, 'description': 'Map intensiy values (output), must be same size as input', 'max': None, 'is_vector': True, 'edit_method': '""', 'name': 'remap_out', 'min': None, 'default': None, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::vector<int>'}, {'constant': False, 'description': 'Path to a mask of same size as input image', 'pytype': 'str', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'mask', 'min': None, 'default': '', 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'std::string'}, {'constant': False, 'description': 'Overwrite base_width', 'pytype': 'double', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'base_width', 'min': None, 'default': '-1', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'double'}, {'constant': False, 'description': 'Overwrite focal length', 'pytype': 'double', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'focal_length', 'min': None, 'default': '-1', 'level': 0, 'is_map': False, 'configurable': True, 'global_scope': False, 'type': 'double'}]
...
class Disp2pointcloudInterface(dict):
    def __init__(self):
