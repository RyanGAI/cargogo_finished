...
inf = float('inf')
param_description = [{'constant': False, 'description': 'Handler should keep node from starting, when no default is given here or at launch.', 'pytype': 'int', 'max': None, 'is_vector': False, 'edit_method': '""', 'name': 'int_param', 'min': None, 'default': None, 'level': 0, 'is_map': False, 'configurable': False, 'global_scope': False, 'type': 'int'}]
