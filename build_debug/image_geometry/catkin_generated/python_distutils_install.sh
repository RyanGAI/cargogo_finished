...
echo_and_run /usr/bin/env \
    PYTHONPATH="/home/kal5-1/cargogo/install_debug/lib/python2.7/dist-packages:/home/kal5-1/cargogo/build_debug/image_geometry/lib/python2.7/dist-packages:$PYTHONPATH" \
    CATKIN_BINARY_DIR="/home/kal5-1/cargogo/build_debug/image_geometry" \
    "/opt/mrtsoftware/release/lib/mrt-build-tools/bin/python" \
    "/home/kal5-1/cargogo/src/vision_opencv/image_geometry/setup.py" \
    build --build-base "/home/kal5-1/cargogo/build_debug/image_geometry" \
    install \
    $DESTDIR_ARG \
